...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            import_pipeline::commands::resolve_legacy_treatment_with_catalog,
            import_pipeline::commands::resolve_legacy_treatment_with_new_catalog,
            import_pipeline::commands::resolve_legacy_treatment_with_pending_catalog,
            import_pipeline::commands::clear_legacy_treatment_resolution,
            ...
            import_pipeline::commands::check_doc_conversion_environment,
            import_pipeline::commands::download_libreoffice_portable,
